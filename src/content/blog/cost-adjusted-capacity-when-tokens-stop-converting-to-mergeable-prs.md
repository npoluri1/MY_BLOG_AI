---
title: "Cost-adjusted capacity when tokens stop converting to mergeable PRs"
description: "Discusses agent capacity economics when token volume stops predicting mergeable output."
pubDate: 2025-07-17
tags:
  - "ai"
  - "agents"
...
Discusses agent capacity economics when token volume stops predicting mergeable output.

## The problem

Most teams approach cost-adjusted capacity when tokens stop converting to mergeable prs from the wrong angle. The visible symptom tells you something is off; the underlying mechanism is what actually matters. Without diagnosing the mechanism, you end up treating symptoms indefinitely.
...
**Originally published by [Devlin Liles](https://www.devlinliles.com/) on 2025-07-17.** [Read the original on devlinliles.com ->](https://www.devlinliles.com/cost-adjusted-capacity-when-tokens-stop-converting-to-mergeable-prs/)