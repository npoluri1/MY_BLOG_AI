---
title: "Judgment was built by proxy"
description: "Examines how human judgment is increasingly trained into model proxies."
pubDate: 2025-07-16
tags:
  - "ai"
  - "philosophy"
...
Examines how human judgment is increasingly trained into model proxies.

## The problem

Most teams approach judgment was built by proxy from the wrong angle. The visible symptom tells you something is off; the underlying mechanism is what actually matters. Without diagnosing the mechanism, you end up treating symptoms indefinitely.
...
**Originally published by [Devlin Liles](https://www.devlinliles.com/) on 2025-07-16.** [Read the original on devlinliles.com ->](https://www.devlinliles.com/judgment-was-built-by-proxy/)
