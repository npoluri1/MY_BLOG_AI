---
title: "Trust was always the problem: from DevOps to agentic AI"
description: "DevOps-era trust lessons applied to agentic AI."
pubDate: 2025-07-11
tags:
  - "devops"
  - "trust"
...
DevOps-era trust lessons applied to agentic AI.

## The problem

Most teams approach trust was always the problem: from devops to agentic ai from the wrong angle. The visible symptom tells you something is off; the underlying mechanism is what actually matters. Without diagnosing the mechanism, you end up treating symptoms indefinitely.
...
**Originally published by [Devlin Liles](https://www.devlinliles.com/) on 2025-07-11.** [Read the original on devlinliles.com ->](https://www.devlinliles.com/trust-was-always-the-problem-from-devops-to-agentic-ai/)
