---
title: "ImprovingU: institutionalizing learning"
description: "Creating structures that make the right kind of learning happen."
pubDate: 2025-07-07
tags:
  - "learning"
category: ["learning"]
...
Creating structures that make the right kind of learning happen.

## The problem

Most teams approach improvingu: institutionalizing learning from the wrong angle. The visible symptom tells you something is off; the underlying mechanism is what actually matters. Without diagnosing the mechanism, you end up treating symptoms indefinitely.
...
**Originally published by [Devlin Liles](https://www.devlinliles.com/) on 2025-07-07.** [Read the original on devlinliles.com ->](https://www.devlinliles.com/improvingu-what-it-looks-like-to-institutionalize-learning/)
