...
description: "Advises against rushing to train custom models."
pubDate: 2025-07-16
tags:
  - "ai"
  - "economics"
...
Advises against rushing to train custom models.

## The problem

Most teams approach maximizing roi in ai: the case for leveraging off-the-shelf solutions from the wrong angle. The visible symptom tells you something is off; the underlying mechanism is what actually matters. Without diagnosing the mechanism, you end up treating symptoms indefinitely.
...
**Originally published by [Devlin Liles](https://www.devlinliles.com/) on 2025-07-16.** [Read the original on devlinliles.com ->](https://www.devlinliles.com/maximizing-roi-in-ai-the-case-for-leveraging-off-the-shelf-solutions/)