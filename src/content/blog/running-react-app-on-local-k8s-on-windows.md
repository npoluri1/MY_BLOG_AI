...
Won't be covering the installation process of [Docker Desktop](https://desktop.docker.com/win/stable/Docker%20Desktop%20Installer.exe) and enabling the [WSL2 backend](https://docs.docker.com/docker-for-windows/wsl/#develop-with-docker-and-wsl-2) here in this blog. Assumption is that readers can figure out the process from the given resources on their own.
...
Browse to the URL shown in the output above.
