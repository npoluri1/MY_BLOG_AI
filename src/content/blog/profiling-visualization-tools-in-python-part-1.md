...
*Original post*: [on medium](https://medium.com/@<username>/profiling-and-visualization-tools-in-python-89a46f578989) *Also posted*: [on dev.to](https://dev.to/<username>/profiling-and-visualization-tools-in-python-376h)
