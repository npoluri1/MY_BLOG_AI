---
title: "Software craftsmanship is not a job title"
description: "Craftsmanship is practices, not labels."
pubDate: 2025-07-11
tags:
  - "craft"
  - "process"
...
Craftsmanship is practices, not labels.

## The problem

Most teams approach software craftsmanship is not a job title from the wrong angle. The visible symptom tells you something is off; the underlying mechanism is what actually matters. Without diagnosing the mechanism, you end up treating symptoms indefinitely.
...
**Originally published by [Devlin Liles](https://www.devlinliles.com/) on 2025-07-11.** [Read the original on devlinliles.com ->](https://www.devlinliles.com/software-craftsmanship-is-not-a-job-title/)
