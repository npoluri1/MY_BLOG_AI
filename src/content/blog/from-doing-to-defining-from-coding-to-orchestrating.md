---
title: "From doing to defining: from coding to orchestrating"
description: "Quintessential shift in engineer definition."
pubDate: 2025-06-19
tags:
  - "evolution"
category: ["evolution"]
...
Quintessential shift in engineer definition.

## The problem

Most teams approach from doing to defining: from coding to orchestrating from the wrong angle. The visible symptom tells you something is off; the underlying mechanism is what actually matters. Without diagnosing the mechanism, you end up treating symptoms indefinitely.
...
**Originally published by [Devlin Liles](https://www.devlinliles.com/) on 2025-06-19.** [Read the original on devlinliles.com ->](https://www.devlinliles.com/from-doing-to-defining-from-coding-to-orchestrating/)