...
![Setting up Claude Code](/_astro/claude_code_setup.CLoAZwlM.jpg)
...
> **Warning:** Avoid installing with `sudo` (`sudo npm install -g ...`), as this can lead to write permission conflicts when Claude Code attempts to read your local files or execute diagnostic checks.
