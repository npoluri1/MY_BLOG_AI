---
title: "Direct API integration: removing the CLI layer"
description: "Agents calling APIs directly vs shelling out."
pubDate: 2025-07-04
tags:
  - "ai"
  - "api"
...
Agents calling APIs directly vs shelling out.

## The problem

Most teams approach direct api integration: removing the cli layer from the wrong angle. The visible symptom tells you something is off; the underlying mechanism is what actually matters. Without diagnosing the mechanism, you end up treating symptoms indefinitely.
...
**Originally published by [Devlin Liles](https://www.devlinliles.com/) on 2025-07-04.** [Read the original on devlinliles.com ->](https://www.devlinliles.com/direct-api-integration-for-ai-agents-lessons-from-removing-the-cli-layer/)