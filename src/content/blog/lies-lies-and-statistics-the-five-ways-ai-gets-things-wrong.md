---
title: "Lies, lies and statistics: the five ways AI gets things wrong"
description: "Categorised AI failure modes."
pubDate: 2025-06-15
tags:
  - "failure"
category: ["failure"]
...
Categorised AI failure modes.

## The problem

Most teams approach lies, lies and statistics: the five ways ai gets things wrong from the wrong angle. The visible symptom tells you something is off; the underlying mechanism is what actually matters. Without diagnosing the mechanism, you end up treating symptoms indefinitely.
...
**Originally published by [Devlin Liles](https://www.devlinliles.com/) on 2025-06-15.** [Read the original on devlinliles.com ->](https://www.devlinliles.com/lies-lies-and-statistics-the-five-ways-ai-gets-things-wrong/)
